...
def get_argparse(force_exp_name=True):
    ...
    parser.add_argument("--exp_name", type=str, help='Name of the experiment', required=force_exp_name,
                        default=exp_name)
    parser.add_argument("--data_dir", type=str, help='Base data directory', default="data/acrobot")
    ...
    parser.add_argument("--heatmap_reg", type=float, default=1.0, help="Coeff for L1 loss on heatmap")
    ...
    parser.add_argument("--temp_width", type=float, default=0.1, help="temporal separation loss width")
